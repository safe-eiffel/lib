...
feature {NONE} -- Implementation
	...
	is_complete_heap (a_container: DS_INDEXABLE [G]; a_comparator: KL_PART_COMPARATOR [G]; lower, upper: INTEGER) : BOOLEAN
	...
	is_semi_complete_heap (a_container: DS_INDEXABLE [G]; a_comparator: KL_PART_COMPARATOR [G]; lower, upper: INTEGER) : BOOLEAN
	...
	test_heap (a_container: DS_INDEXABLE [G]; a_comparator: KL_PART_COMPARATOR [G]; lower, upper: INTEGER; complete : BOOLEAN) : BOOLEAN
